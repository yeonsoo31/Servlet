...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "bSMmG6AxJIdJcFegWp9z";
	private final static String CLIENT_SECRET = "On7XE6XuBu";

	private final static String REDIRECT_URI = "http://localhost:8091/member/yysnaverLoginOK";
